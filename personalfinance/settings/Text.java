...
final public class Text {
    ...
    public static void init() {
        ...
        //else if (Settings.getLanguage().equals("est")) {
            ...
            data.put("FEBRUAR", "Veebruar");
            data.put("MARCH", "Märts");
            data.put("APRIL", "Aprill");
            data.put("MAY", "May");
            data.put("JUNE", "Juuni");
            data.put("JULY", "Juuli");
            ...
            data.put("ERROR", "Viga");
            data.put("ERROR_TITLE_EMPTY", "Te pole nime sisestanud!");
            data.put("ERROR_IS_EXISTS", "See kirje on juba olemas!");
            data.put("ERROR_DATE_FORMAT", "Vale kuupäevavorming!");
            data.put("ERROR_CODE_EMPTY", "Te ei sisestanud koodi!");
            data.put("ERROR_CURRENCY_EMPTY", "Te ei määranud valuutat!");
            data.put("ERROR_ARTICLE_EMPTY", "Te ei täpsustanud artiklit!");
            data.put("ERROR_ACCOUNT_EMPTY", "Te ei määranud kontot!");
            data.put("ERROR_RATE_INCORRECT", "Vale väärtuse väärtus!");
            data.put("ERROR_AMOUNT_FORMAT", "Vale summa vorming!");
            data.put("ERROR_NO_BASE_CURRENCY", "Vajalik baasvaluuta! Esmalt seadke see parameeter teises valuutas, seejärel eemaldatakse see sellest automaatselt.");
            data.put("ERROR_UPDATE_CURRENCIES", "Viga valuutade uuendamisel!");

            data.put("CONFIRM_EXIT_TEXT", "Kas soovite tõesti väljuda? Kõik salvestamata andmed lähevad kaotsi!");
            data.put("CONFIRM_EXIT_TITLE", "Väljumise kinnitus");
            data.put("CONFIRM_DELETE_TEXT", "Kas soovite kindlasti selle kirje kustutada??");
            data.put("CONFIRM_DELETE_TITLE", "Kinnitage");

            data.put("YES", "Jah");
            data.put("NO", "Ei");

            data.put("MENU_FILE", "Fail");
            data.put("MENU_EDIT", "Redigeeri");
            data.put("MENU_VIEW", "Vaade");
            data.put("MENU_SETTINGS", "Seadistused");
            data.put("MENU_HELP", "Abi");

            data.put("MENU_FILE_NEW", "Uus");
            data.put("MENU_FILE_OPEN", "Ava");
            data.put("MENU_FILE_SAVE", "Salvesta");
            data.put("MENU_FILE_UPDATE_CURRENCIES", "Valuuta uuendus");
            data.put("MENU_FILE_EXIT", "Exit");

            data.put("MENU_EDIT_ADD", "Lisa");
            data.put("MENU_EDIT_EDIT", "Redigeri");
            data.put("MENU_EDIT_DELETE", "Kustuta");

            data.put("MENU_VIEW_OVERVIEW", "Ülevaade");
            data.put("MENU_VIEW_ACCOUNTS", "Kontod");
            data.put("MENU_VIEW_ARTICLES", "Artiklid");
            data.put("MENU_VIEW_TRANSACTIONS", "Tehingud");
            data.put("MENU_VIEW_TRANSFERS", "Ülekanded");
            data.put("MENU_VIEW_CURRENCIES", "Valuuta");
            data.put("MENU_VIEW_STATISTICS", "Statistika");

            data.put("MENU_SETTINGS_LANGUAGE", "Keel");
            ...
            data.put("TOOLBAR_OVERVIEW", "Ülevaade");
            data.put("TOOLBAR_ACCOUNTS", "Kontod");
            data.put("TOOLBAR_ARTICLES", "Artiklid");
            data.put("TOOLBAR_TRANSACTIONS", "Tehingud");
            data.put("TOOLBAR_TRANSFERS", "Ülekanded");
            data.put("TOOLBAR_CURRENCIES", "Valuuta");
            data.put("TOOLBAR_STATISTICS", "Statistika");

            data.put("ADD", "Lisa");
            data.put("EDIT", "redigeri");
            data.put("DELETE", "Kustuta");
            data.put("CANCEL", "Tühista");

            data.put("TODAY", "Täna");

            data.put("LABEL_TITLE", "Nimetus:");
            data.put("LABEL_CURRENCY", "Valuuta:");
            data.put("LABEL_START_AMOUNT", "Algsumma:");
            data.put("LABEL_DATE", "Kuupäev:");
            data.put("LABEL_ACCOUNT", "Konto:");
            data.put("LABEL_ARTICLE", "Artikl:");
            data.put("LABEL_AMOUNT", "Summa:");
            data.put("LABEL_NOTICE", "Teade:");
            data.put("LABEL_FROM_ACCOUNT", "Kust:");
            data.put("LABEL_TO_ACCOUNT", "Kuhu:");
            data.put("LABEL_FROM_AMOUNT", "Endassetõmbunud:");
            data.put("LABEL_TO_AMOUNT", "Credited:");
            data.put("LABEL_CODE", "Kood:");
            data.put("LABEL_RATE", "Rate:");
            data.put("LABEL_ON", "Lubatud:");
            data.put("LABEL_BASE", "Põhi:");

            data.put("BALANCE_CURRENCIES", "Saldo valuutade järgi");
            data.put("BALANCE", "Kogujääk");
            ...
            data.put("LAST_TRANSACTIONS", "Viimased tehingud");
            data.put("ACCOUNTS", "Kontod");
            data.put("ARTICLES", "Artiklid");
            data.put("CURRENCIES", "Valuuta");
            data.put("TRANSACTIONS", "Tehingud");
            data.put("TRANSFERS", "Ülekanne");
            data.put("STATISTICS", "Statistika");

            data.put("TITLE", "Nimetus");
            data.put("DATE", "Kuupäev");
            data.put("ACCOUNT", "Konto");
            data.put("ARTICLE", "Artikl");
            data.put("AMOUNT", "Summa");
            data.put("NOTICE", "Teade");
            data.put("FROM_ACCOUNT", "Kust");
            data.put("TO_ACCOUNT", "Kuhu");
            data.put("FROM_AMOUNT", "Endassetõmbunud");
        ...
        //else {
            ...
            data.put("ERROR_CODE_EMPTY", "You did not enter a code!");
